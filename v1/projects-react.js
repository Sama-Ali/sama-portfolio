(function () {
  ...
  function Projects() {
    ...
    return h('div', { className: 'interactive-projects' },
        ...
        displayOrder.map((projectIndex, displayIndex) => {
          ...
          h('button', {
            ...
            h('span', { className: 'project-card-image' },
              h('img', { src: project.image, alt: project.alt, loading: displayIndex > 1 ? 'lazy' : 'eager' }),
      ...
      activeProject && h('div', {
        ...
        h('article', {
          ...
          h('div', { className: `project-modal-image project-card-${projects.indexOf(activeProject) + 1}` },
            h('img', { src: activeProject.image, alt: activeProject.alt })
          ),
          h('div', { className: 'project-modal-content' },
            ...
            h('div', { className: 'project-detail-links' },
              activeProject.live && h('a', { href: activeProject.live, target: '_blank', rel: 'noreferrer' }, 'Live site ↗'),
              h('a', { href: activeProject.github, target: '_blank', rel: 'noreferrer' }, 'GitHub ↗')
            )
          )
        )
      )
